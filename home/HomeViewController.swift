...
//        navigationItem.searchController = searchController
        //設置右側的Item
        let searcheBtn = UIButton()
        searcheBtn.setImage(UIImage(named:"search"), for: .normal)
        //換圖顏色 QRBtn.setImage(UIImage(named:"location"), for: .highlighted)
        searcheBtn.sizeToFit()
        let searcheItem = UIBarButtonItem(customView: searcheBtn)
       ...
       //換圖顏色 QRBtn.setImage(UIImage(named:"location"), for: .highlighted)
        ...
        navigationItem.rightBarButtonItems = [ qrcodeItem, locationItem, searcheItem]
    }
}
